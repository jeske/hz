/*
** $Id: print.h,v 1.1 2000/07/20 10:16:44 jeske Exp $
** opcode info to be #included into print.c
...
*/
  ...
  case OP_PUSHSTRING: P_OP("PUSHSTRING"); P_K; break;
  ...
  case OP_CLOSURE: P_OP("CLOSURE"); P_AB; break;
  case OP_SETLINE: P_OP("SETLINE"); P_LINE; break;
